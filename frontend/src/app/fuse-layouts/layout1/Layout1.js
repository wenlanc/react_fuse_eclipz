				...
				<div id="fuse-layout" className={clsx(classes.root, config.mode, `scroll-${config.scroll}`)}>
					...
					<div className="flex flex-1 flex-col overflow-hidden relative">
						{config.toolbar.display &&
							...
							config.toolbar.position === 'above' && <ToolbarLayout1 history={props.history} />}
							...
							<div className={classes.wrapper}>
								...
								<div className={classes.contentWrapper}>
									{config.toolbar.display && config.toolbar.position === 'below' && (
										<ToolbarLayout1 history={props.history} />
									)}
		...
		default: {
			return (
				<div id="fuse-layout" className={clsx(classes.root, config.mode, `scroll-${config.scroll}`)}>
					...
					<div className="flex flex-1 flex-col overflow-hidden relative">
						{config.toolbar.display && config.toolbar.position === 'above' && <ToolbarLayout1 history={props.history} />}
						...
						<div className={classes.wrapper}>
							...
							<div className={classes.contentWrapper}>
								{config.toolbar.display &&
									...
									config.toolbar.style === 'fixed' && <ToolbarLayout1 history={props.history} />}
