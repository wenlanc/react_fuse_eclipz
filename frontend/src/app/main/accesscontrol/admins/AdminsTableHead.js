...
function AdminsTableHead(props) {
	...
	const [selectedAdminsMenu, setSelectedAdminsMenu] = useState(null);
	...
	function openSelectedAdminsMenu(event) {
		setSelectedAdminsMenu(event.currentTarget);
	}

	function closeSelectedAdminsMenu() {
		setSelectedAdminsMenu(null);
	}
	...
	const handleConfirmRemove = () => {
		dispatch(Actions.removeAdmins(selectedAdminIds));
		handleClose();
		props.setSelected([]);
	}
		...
		<TableHead>
			<TableRow className="h-64">
				<TableCell padding="none" className="relative w-64 text-center">
					...
					/>
					{ authUser.role == 'superadmin' && props.numSelected > 0 && (
						<div
							className={clsx(
						...
						>
							<IconButton
								...
								aria-haspopup="true"
								onClick={openSelectedAdminsMenu}
							>
							...
							<Menu
								...
								onClose={closeSelectedAdminsMenu}
							>
								<MenuList>
