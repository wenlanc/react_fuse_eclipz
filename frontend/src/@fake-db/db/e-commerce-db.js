...
mock.onGet('/api/e-commerce-app/user').reply(request => {
	const { userId } = request.params;
	const response = _.find(eCommerceDB.products, { id: userId });
	return [200, response];
});

mock.onGet('/api/e-commerce-app/admin').reply(request => {
	const { adminId } = request.params;
	const response = _.find(eCommerceDB.products, { id: adminId });
	return [200, response];
});

mock.onGet('/api/e-commerce-app/service').reply(request => {
	const { serviceId } = request.params;
	const response = _.find(eCommerceDB.products, { id: serviceId });
	return [200, response];
});
...
mock.onGet('/api/e-commerce-app/domain').reply(request => {
	const { domainId } = request.params;
	const response = _.find(eCommerceDB.products, { id: domainId });
	return [200, response];
});

mock.onGet('/api/e-commerce-app/group').reply(request => {
	const { groupId } = request.params;
	const response = _.find(eCommerceDB.products, { id: groupId });
	return [200, response];
});